 ...
 * - Category assignment
 * - Pricing (contractor/retail)
 * - Unit type (ton, yard, each)
 * - Inventory settings (track inventory, reorder point)
 */
...
export default function NewProductModal({
  ...
  const [unit, setUnit] = useState<'ton' | 'yard' | 'each'>('yard');
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await invoissAPI.updateProduct('new', {
        name,
